...
timeWindow = 12 * NumberOfYears;        % Convert years into months
...
[ ~, returnsSelected, ~] = returnsOfInterest(inputFile, refDate, ...
        timeWindow, sharesList, formatDate); % Select 2y returns of interest
...
[ ~, rate] = find_rate_from_bootstrap_curve(expiry_date); % zero rate
